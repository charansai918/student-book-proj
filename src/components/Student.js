        ...
        <div>
          <form className='student-form'>
            ...
            <div>
                ...
                <button className='cancel-button' onClick={() => clearingForm()}>Cancel</button>
            </div>
            ...
            <table className='grid-data'>
                ...
                {gridBody && <tbody>
                    <tr>
                        ...
                        <td><img src={formData.profilePic} alt="" width="90px" height="100px"></img></td>
                        <td><video src={formData.video} controls autoPlay muted width="120px" height="80px"></video></td>
                        <td>
                            <button className='edit-button' onClick={() => editField()}>Edit</button>
                            <button className='delete-button' onClick={() => deletingEntry()}>Delete</button>
